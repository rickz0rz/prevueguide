...
public class Guide : IDisposable
{
    ...
    private void Render()
    {
        ...
        {
            using (_ = new RenderingTarget(_renderer, _textureManager[GuideTextureKey]))
            {
        ...
        _ = SDL.RenderTexture(_renderer, _textureManager[GuideTextureKey].SdlTexture, IntPtr.Zero, guideFRect);
